...
ENTRY_POINT = ROOT_DIR / "clbot" / "__main__.py"
...
version_file = ROOT_DIR / "clbot" / "__version__"
...
build_exe_options = {
    ...
    "packages": ["clbot", "ttkbootstrap", "tkinter"],
    "include_files": [
        ROOT_DIR / "assets" / "pixel-pycb.ico",
        ROOT_DIR / "clbot" / "detection" / "reference_images",
        ROOT_DIR / "clbot" / "__version__",
    ],
    "include_msvcr": True,
}
...
bdist_msi_options = {
    ...
    "output_name": f"clbot-{VERSION}-win64.msi",
