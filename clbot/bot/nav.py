...
from clbot.bot.coords import CLASH_MAIN_DEADSPACE_COORD as CLASH_MAIN_MENU_DEADSPACE_COORD
from clbot.bot.find import find_fight_mode_icon, find_post_battle_button
...
from clbot.detection.image_rec import find_image
