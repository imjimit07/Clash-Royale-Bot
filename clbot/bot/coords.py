...
# --- Fight: ML tactical placement (419x633 resolution standard) ---
# Used by bot/ml_agent.py for role-based placement. Kept here per the
# coords rule (no raw tuples in feature modules).
ML_LEFT_BRIDGE = (102, 280)
ML_RIGHT_BRIDGE = (315, 280)
ML_CENTER_POCKET = (209, 330)
ML_LEFT_BACK = (102, 490)
ML_RIGHT_BACK = (315, 490)
ML_KING_CENTER = (209, 440)
ML_ENEMY_LEFT_TOWER = (115, 185)
ML_ENEMY_RIGHT_TOWER = (300, 185)
ML_FALLBACK_POCKET = (209, 390)

# --- Fight: threat-aware tactical anchors (419x633 resolution standard) ---
# Used by bot/ml_agent.py (VisionThreatDetector/TacticalAIEngine). Kept here
# per the coords rule (no raw tuples in feature modules).
TACT_LEFT_BRIDGE = (105, 275)
TACT_RIGHT_BRIDGE = (315, 275)
TACT_LEFT_BACK = (105, 510)
TACT_RIGHT_BACK = (315, 510)
TACT_CENTER_PULL = (210, 390)
TACT_CENTER_ANTI_AIR = (210, 430)
TACT_KING_TOWER = (210, 480)
TACT_ENEMY_LEFT_TOWER = (115, 185)
TACT_ENEMY_RIGHT_TOWER = (305, 185)

# --- Fight: elixir bar scanner (419x633 resolution standard) ---
# Horizontal purple fill bar near the screen bottom, read by bot/elixir.py.
# Cross-checked against state_detect.ELIXIR_COORDS pip rows (y≈613, x 149-364).
ELIXIR_BAR_Y = 612
ELIXIR_BAR_X_START = 110
ELIXIR_BAR_X_END = 370

# --- Fight: cross-lane kiting (419x633 resolution standard) ---
# A left-lane threat is pulled slightly RIGHT of center (and vice versa) so
# both Princess Towers engage it simultaneously. Used by AdvancedCombatAI.
KITE_PULL_LEFT_THREAT = (235, 395)
KITE_PULL_RIGHT_THREAT = (185, 395)
