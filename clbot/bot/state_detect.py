...
This module is a leaf: the only clbot.bot module it imports from is
`coords` (itself a leaf — pure data, no imports). No nav, fight, deck, etc.
"""

import numpy

from clbot.bot.coords import MORE_CLAN_CHAT_CARD_OPTIONS_SUBCROP
from clbot.detection.image_rec import (
