...
Imports only from clbot.detection.*, clbot.utils.*, and clbot.bot.coords.
Never imports from other clbot.bot.* modules, with one exception:
...
from clbot.bot.coords import UPGRADE_POINTS
from clbot.bot.state_detect import pixel_indicates_upgradable
from clbot.detection.image_rec import find_image, pixel_is_equal
